...
//  twitter-clone
//
//  Created by Misael Rivera on 04/07/20.
//  Copyright © 2020 Misael Rivera. All rights reserved.
//

import UIKit

private let reuseIndentifer = "ActionSheetCell"
...
class ActionSheetLauncher: NSObject {
    ...
    //MARK: Selecters
    @objc func handleDismissal(sender : UIView) {
    ...
    func configureTableView() {
        ...
        tableView.register(ActionSheetCell.self, forCellReuseIdentifier: reuseIndentifer)
    }
...
extension ActionSheetLauncher: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIndentifer, for: indexPath) as! ActionSheetCell
